...
test("production readiness roadmap records required launch gates and Codex rules", async () => {
  ...
  const requiredPhrases = [
    ...
    "Swooshz Quote Auto Generator launch handoff gate",
    "34-screen Stitch visual/layout freeze candidate",
    "scoped public, portal, workspace-admin, access-information, and resources slices are locally implemented after PRs #86-#90",
    "full frontend launch clearance, production copy, consolidated screenshot parity, and hosted visual evidence remain unchecked",
