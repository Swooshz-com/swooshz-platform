...
test("production readiness roadmap records required launch gates and Codex rules", async () => {
  ...
  const requiredPhrases = [
    ...
    "hosted Auth0/passwordless email OTP/auth/role smoke gate",
    "backup/restore gate",
    "logging/monitoring/incident gate",
    "security hardening gate",
    "Swooshz Quote Auto Generator launch handoff gate",
    "Prestige public site and approved compact authenticated launcher/admin interface are implemented locally",
    "Full frontend launch clearance, hosted visual evidence, and hosted smoke remain unchecked",
