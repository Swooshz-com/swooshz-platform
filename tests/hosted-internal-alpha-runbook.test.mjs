...
test("hosted runbook preserves the rollback-gated runtime activation contract", async () => {
  ...
  const requiredPhrases = [
    ...
    "fresh endpoint evidence from the official",
    "createNeonProviderTargetBinding",
    "exact project ID",
    "exact branch ID",
    "approved direct and/or pooled compute",
    "provider-observed host",
    "never replaces project/branch identity",
    ...
    "unexpired trusted",
    "connection-string stability never overrides provider identity",
