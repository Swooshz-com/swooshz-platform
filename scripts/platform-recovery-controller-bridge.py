...
CANONICAL_LOADER_PAYLOAD_BYTES = (
    ...
    b"        if name in _PROCESS_CAPABILITY_POLICY.get(root, ()):\n"
    b"            raise AttributeError(name)\n"
    ...
    b"        module = object.__getattribute__(self, \"_module\")\n"
    b"        root = object.__getattribute__(self, \"_root\")\n"
    b"        denied = _PROCESS_CAPABILITY_POLICY.get(root, ())\n"
    ...
    b"    if any(name not in options for name in required):\n"
    b"        _fail(RunnerControlCode.SUBPROCESS_STDIO_REQUIRED)\n"
    ...
    b"        _fail(RunnerControlCode.SUBPROCESS_STDIO_REQUIRED)\n"
    b"    if \"pass_fds\" in options and (type(options[\"pass_fds\"]) is not tuple or options[\"pass_fds\"] != ()):\n"
    b"        _fail(RunnerControlCode.SUBPROCESS_STDIO_REQUIRED)\n"
    b"\n"
