...
CANONICAL_LOADER_PAYLOAD_BYTES = (
    ...
    b"_CAPABILITY_INVENTORY_ROOTS = (\"os\", \"contextlib\", \"signal\")\n"
    ...
    b"    \"register_at_fork\",\n"
    b"    \"abort\", \"kill\", \"killpg\", \"wait\", \"wait3\", \"wait4\",\n"
    b"    \"waitid\", \"waitpid\", \"getpid\", \"getppid\",\n"
    b"    \"open\", \"fdopen\", \"read\", \"write\", \"close\", \"replace\",\n"
    b"    \"environ\", \"getenv\", \"putenv\", \"unsetenv\",\n"
    b"    \"add_dll_directory\",\n"
    b"})\n"
    b"_CAPABILITY_CLASSIFICATION_REGISTRY = _types.MappingProxyType({\n"
    b"    \"nt\": _types.MappingProxyType({\n"
    b"        \"os\": _types.MappingProxyType({\n"
    b"            \"system\": \"DENY\", \"popen\": \"DENY\", \"startfile\": \"DENY\",\n"
    b"            \"fork\": \"DENY\", \"forkpty\": \"DENY\", \"vfork\": \"DENY\",\n"
    b"            \"posix_spawn\": \"DENY\", \"posix_spawnp\": \"DENY\",\n"
    b"            \"execl\": \"DENY\", \"execle\": \"DENY\", \"execlp\": \"DENY\", \"execlpe\": \"DENY\",\n"
    b"            \"execv\": \"DENY\", \"execve\": \"DENY\", \"execvp\": \"DENY\", \"execvpe\": \"DENY\",\n"
    b"            \"spawnl\": \"DENY\", \"spawnle\": \"DENY\", \"spawnlp\": \"DENY\", \"spawnlpe\": \"DENY\",\n"
    b"            \"spawnv\": \"DENY\", \"spawnve\": \"DENY\", \"spawnvp\": \"DENY\", \"spawnvpe\": \"DENY\",\n"
    b"            \"P_WAIT\": \"DENY\", \"P_NOWAIT\": \"DENY\", \"P_NOWAITO\": \"DENY\", \"P_OVERLAY\": \"DENY\",\n"
    b"            \"P_DETACH\": \"DENY\", \"P_DETACHED\": \"DENY\",\n"
    b"            \"dup\": \"DENY\", \"dup2\": \"DENY\", \"dup3\": \"DENY\", \"pipe\": \"DENY\", \"pipe2\": \"DENY\",\n"
    b"            \"openpty\": \"DENY\", \"posix_openpt\": \"DENY\", \"grantpt\": \"DENY\", \"unlockpt\": \"DENY\",\n"
    b"            \"login_tty\": \"DENY\",\n"
    b"            \"get_inheritable\": \"DENY\", \"set_inheritable\": \"DENY\",\n"
    b"            \"get_handle_inheritable\": \"DENY\", \"set_handle_inheritable\": \"DENY\",\n"
    b"            \"get_blocking\": \"DENY\", \"set_blocking\": \"DENY\", \"pidfd_getfd\": \"DENY\",\n"
    b"            \"O_CLOEXEC\": \"DENY\", \"O_CLOFORK\": \"DENY\", \"O_NOINHERIT\": \"DENY\",\n"
    b"            \"register_at_fork\": \"DENY\",\n"
    b"            \"abort\": \"RETAIN_SAFE\", \"kill\": \"RETAIN_SAFE\", \"waitpid\": \"RETAIN_SAFE\",\n"
    b"            \"getpid\": \"RETAIN_SAFE\", \"getppid\": \"RETAIN_SAFE\",\n"
    b"            \"open\": \"RETAIN_SAFE\", \"fdopen\": \"RETAIN_SAFE\", \"read\": \"RETAIN_SAFE\",\n"
    b"            \"write\": \"RETAIN_SAFE\", \"close\": \"RETAIN_SAFE\", \"replace\": \"RETAIN_SAFE\",\n"
    b"            \"environ\": \"RETAIN_SAFE\", \"getenv\": \"RETAIN_SAFE\", \"putenv\": \"RETAIN_SAFE\",\n"
    b"            \"unsetenv\": \"RETAIN_SAFE\", \"add_dll_directory\": \"RETAIN_SAFE\",\n"
    b"        }),\n"
    b"        \"contextlib\": _types.MappingProxyType({\n"
    b"            \"redirect_stdin\": \"DENY\", \"redirect_stdout\": \"DENY\",\n"
    b"            \"redirect_stderr\": \"DENY\",\n"
    b"        }),\n"
    b"        \"signal\": _types.MappingProxyType({\n"
    b"            \"set_wakeup_fd\": \"DENY\",\n"
    b"        }),\n"
    b"        \"subprocess\": _types.MappingProxyType({\n"
    b"            \"PIPE\": \"GUARDED_SAFE\", \"DEVNULL\": \"GUARDED_SAFE\",\n"
    b"            \"STDOUT\": \"GUARDED_SAFE\", \"TimeoutExpired\": \"GUARDED_SAFE\",\n"
    b"            \"CompletedProcess\": \"GUARDED_SAFE\", \"Popen\": \"GUARDED_SAFE\",\n"
    b"            \"run\": \"GUARDED_SAFE\", \"check_output\": \"GUARDED_SAFE\",\n"
    b"        }),\n"
    b"        \"sys\": _types.MappingProxyType({\n"
    b"            \"executable\": \"GUARDED_SAFE\", \"stdin\": \"GUARDED_SAFE\",\n"
    b"            \"stdout\": \"GUARDED_SAFE\", \"stderr\": \"GUARDED_SAFE\",\n"
    b"            \"__stdin__\": \"GUARDED_SAFE\", \"__stdout__\": \"GUARDED_SAFE\",\n"
    b"            \"__stderr__\": \"GUARDED_SAFE\",\n"
    b"        }),\n"
    b"    }),\n"
    b"    \"posix\": _types.MappingProxyType({\n"
    b"        \"os\": _types.MappingProxyType({\n"
    b"            \"system\": \"DENY\", \"popen\": \"DENY\", \"startfile\": \"DENY\",\n"
    b"            \"fork\": \"DENY\", \"forkpty\": \"DENY\", \"vfork\": \"DENY\",\n"
    b"            \"posix_spawn\": \"DENY\", \"posix_spawnp\": \"DENY\",\n"
    ...
    b"            \"O_CLOEXEC\": \"DENY\", \"O_CLOFORK\": \"DENY\", \"O_NOINHERIT\": \"DENY\",\n"
    b"            \"register_at_fork\": \"DENY\",\n"
    b"            \"abort\": \"RETAIN_SAFE\", \"kill\": \"RETAIN_SAFE\", \"killpg\": \"RETAIN_SAFE\",\n"
    b"            \"wait\": \"RETAIN_SAFE\", \"wait3\": \"RETAIN_SAFE\", \"wait4\": \"RETAIN_SAFE\",\n"
    b"            \"waitid\": \"RETAIN_SAFE\", \"waitpid\": \"RETAIN_SAFE\",\n"
    b"            \"getpid\": \"RETAIN_SAFE\", \"getppid\": \"RETAIN_SAFE\",\n"
    b"            \"open\": \"RETAIN_SAFE\", \"fdopen\": \"RETAIN_SAFE\", \"read\": \"RETAIN_SAFE\",\n"
    b"            \"write\": \"RETAIN_SAFE\", \"close\": \"RETAIN_SAFE\", \"replace\": \"RETAIN_SAFE\",\n"
    b"            \"environ\": \"RETAIN_SAFE\", \"getenv\": \"RETAIN_SAFE\", \"putenv\": \"RETAIN_SAFE\",\n"
    b"            \"unsetenv\": \"RETAIN_SAFE\",\n"
    b"        }),\n"
    b"        \"contextlib\": _types.MappingProxyType({\n"
    b"            \"redirect_stdin\": \"DENY\", \"redirect_stdout\": \"DENY\",\n"
    b"            \"redirect_stderr\": \"DENY\",\n"
    ...
    b"    sources = {\"os\": _os, \"contextlib\": _ctx, \"signal\": _signal}\n"
    ...
    b"        for name in public_names:\n"
    b"            if root == \"os\":\n"
    b"                relevant = (\n"
    b"                    name in _CAPABILITY_OS_NAMES\n"
    b"                    or name.startswith((\"exec\", \"spawn\", \"fork\", \"posix_spawn\", \"dup\", \"pipe\"))\n"
    b"                )\n"
    b"            elif root == \"contextlib\":\n"
    b"                relevant = name.startswith(\"redirect_\")\n"
    b"            else:\n"
    b"                relevant = name == \"set_wakeup_fd\"\n"
    b"            if relevant:\n"
    b"                observed.append((platform, root, name))\n"
    b"    return tuple(sorted(observed))\n"
    b"\n"
