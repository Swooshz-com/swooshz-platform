...
export const HTTP_ROUTE_CONTRACTS: readonly HttpRouteContract[] = [
  ...
  },
  {
    ...
    requiredQuery: [],
    handlerContract: "renderResourcesPage",
    responseKind: "html",
    idempotent: true,
    implemented: true,
  },
  {
    id: "platform_resource_article_page",
    method: "GET",
    path: "/resources/platform-launch-boundaries",
    browserSession: "none",
    csrf: {
      required: false,
      strategy: "none",
    ...
    requiredQuery: [],
    handlerContract: "renderResourceArticlePage",
    responseKind: "html",
    idempotent: true,
    implemented: true,
  },
  ...
  {
    id: "platform_workspace_member_remove",
    method: "POST",
    path: "/api/platform/workspaces/:workspaceId/members/:membershipId/remove",
    browserSession: "required",
    csrf: {
      required: true,
      strategy: "origin_referer_and_csrf_token",
    ...
    requiredQuery: [],
    handlerContract: "handleWorkspaceMembershipRemoveRequest",
    responseKind: "json",
    idempotent: false,
    implemented: true,
  },
